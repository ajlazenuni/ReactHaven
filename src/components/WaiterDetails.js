...
import defaultUserPhoto from '../assets/user.jpg'; // Adjust the path as needed
...
const WaiterDetails = ({ waiters }) => {
    ...
    return (
        <div className="waiter-details-page">
            ...
            <div className="waiter-details-container">
                <div className="waiter-left">
                    <div className="waiter-personal-details">
                        <div className="profile-picture">
                            <img src={waiter.profilePicture || defaultUserPhoto} alt={`${waiter.fullName}`} />
                        </div>
